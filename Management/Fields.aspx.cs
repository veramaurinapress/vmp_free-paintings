...
public partial class Management_Fields : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        switch (e.Row.RowType)
        {
            case DataControlRowType.DataRow:
                ...
                if (Convert.ToInt32(myDataRowView["NumberOfTexts"]) > 0)
                {
    ...
    protected void SqlDataSource1_Deleted(object sender, SqlDataSourceStatusEventArgs e)
    {
        if (e.Exception != null && e.Exception is SqlException)
        {
            ...
            {
                ErrorMessage.Text = @"You can't delete this genre because it has associated reviews that you need to delete first.";
